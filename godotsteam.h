...
private:
	...
	// Video callbacks //////////////////////
	STEAM_GAMESERVER_CALLBACK(SteamServer, get_opf_settings_result, GetOPFSettingsResult_t, callbackGetOPFSettingsResult);
	STEAM_GAMESERVER_CALLBACK(SteamServer, get_video_result, GetVideoURLResult_t, callbackGetVideoResult);
