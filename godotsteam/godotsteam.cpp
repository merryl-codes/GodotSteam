...
SteamServer::SteamServer():
	...
	callbackRemotePlaySessionConnected(this, &SteamServer::remote_play_session_connected),
	callbackRemotePlaySessionDisconnected(this, &SteamServer::remote_play_session_disconnected),

	// Remote Storage callbacks /////////////////
	callbackLocalFileChanged(this, &SteamServer::local_file_changed),

	// Screenshot callbacks /////////////////////
	callbackScreenshotReady(this, &SteamServer::screenshot_ready),
	callbackScreenshotRequested(this, &SteamServer::screenshot_requested),
...
/////////////////////////////////////////////////
//
//! Checks if steam master server requested restart of server
...
int16 SteamServer::getFriendsGroupIDByIndex(int friend_group){
	if(SteamFriends() == NULL){
		return 0;
	}
...
int SteamServer::getFriendsGroupMembersCount(int friend_group){
	if(SteamFriends() == NULL){
		return 0;
	}
...
Array SteamServer::getFriendsGroupMembersList(int friend_group, int member_count){
	Array member_list;
	if(SteamFriends() == NULL){
		return member_list;
	}
...
String SteamServer::getFriendsGroupName(int friend_group){
	if(SteamFriends() == NULL){
		return "";
	}
...
int SteamServer::addFavoriteGame(uint32 ip, int port, int query_port, uint32 flags, uint32 last_played){
	if(SteamMatchmaking() == NULL){
		return 0;
	}
...
bool SteamServer::removeFavoriteGame(uint32 app_id, uint32 ip, int port, int query_port, uint32 flags){
	if(SteamMatchmaking() == NULL){
		return false;
	}
...
void SteamServer::setLobbyGameServer(uint64_t steam_lobby_id, const String& server_ip, int server_port, uint64_t steam_id_game_server){
	if(SteamMatchmaking() != NULL){
...
int SteamServer::pingServer(const String& ip, int port){
	int response = 0;
	if(SteamMatchmakingServers() != NULL){
...
int SteamServer::playerDetails(const String& ip, int port){
	int response = 0;
	if(SteamMatchmakingServers() != NULL){
		if(ip.is_valid_ip_address()){
			char ip_bytes[4];
...
int SteamServer::serverRules(const String& ip, int port){
	int response = 0;
	if(SteamMatchmakingServers() != NULL){
		if(ip.is_valid_ip_address()){
			char ip_bytes[4];
...
Dictionary SteamServer::initiateGameConnection(uint64_t server_id, uint32 server_ip, int server_port, bool secure){
...
void SteamServer::terminateGameConnection(uint32 server_ip, int server_port){
	if(SteamUser() != NULL){
...
void SteamServer::remote_play_session_connected(SteamRemotePlaySessionConnected_t* call_data){
...
void SteamServer::remote_play_session_disconnected(SteamRemotePlaySessionDisconnected_t* call_data){
	uint32 session_id = call_data->m_unSessionID;
...
void SteamServer::screenshot_ready(ScreenshotReady_t* call_data){
...
void SteamServer::screenshot_requested(ScreenshotRequested_t* call_data){
...
void SteamServer::_bind_methods(){
	...
	ClassDB::bind_method(D_METHOD("checkMasterRestartRequest", "app_id"), &SteamServer::checkMasterRestartRequest);
	ClassDB::bind_method(D_METHOD("serverInit", "bind_ip", "game_port", "query_port", "server_mode", "version_string"), &SteamServer::serverInit);
	ClassDB::bind_method(D_METHOD("steamShutdown"), &SteamServer::steamShutdown);

	// APPS BIND METHODS ////////////////////////
	ClassDB::bind_method(D_METHOD("getDLCDataByIndex"), &SteamServer::getDLCDataByIndex);
	ClassDB::bind_method(D_METHOD("isAppInstalled", "app_id"), &SteamServer::isAppInstalled);
	ClassDB::bind_method(D_METHOD("isCybercafe"), &SteamServer::isCybercafe);
	ClassDB::bind_method(D_METHOD("isDLCInstalled", "dlc_id"), &SteamServer::isDLCInstalled);
	ClassDB::bind_method(D_METHOD("isLowViolence"), &SteamServer::isLowViolence);
	ClassDB::bind_method(D_METHOD("isSubscribed"), &SteamServer::isSubscribed);
	ClassDB::bind_method(D_METHOD("isSubscribedApp", "app_id"), &SteamServer::isSubscribedApp);
	ClassDB::bind_method(D_METHOD("isSubscribedFromFamilySharing"), &SteamServer::isSubscribedFromFamilySharing);
	ClassDB::bind_method(D_METHOD("isSubscribedFromFreeWeekend"), &SteamServer::isSubscribedFromFreeWeekend);
	ClassDB::bind_method(D_METHOD("isTimedTrial"), &SteamServer::isTimedTrial);
	ClassDB::bind_method(D_METHOD("isVACBanned"), &SteamServer::isVACBanned);
	ClassDB::bind_method(D_METHOD("getAppBuildId"), &SteamServer::getAppBuildId);
	ClassDB::bind_method(D_METHOD("getAppInstallDir", "app_id"), &SteamServer::getAppInstallDir);
	ClassDB::bind_method(D_METHOD("getAppOwner"), &SteamServer::getAppOwner);
	ClassDB::bind_method(D_METHOD("getAvailableGameLanguages"), &SteamServer::getAvailableGameLanguages);
	ClassDB::bind_method(D_METHOD("getCurrentBetaName"), &SteamServer::getCurrentBetaName);
	ClassDB::bind_method(D_METHOD("getCurrentGameLanguage"), &SteamServer::getCurrentGameLanguage);
	ClassDB::bind_method(D_METHOD("getDLCCount"), &SteamServer::getDLCCount);
	...
	ClassDB::bind_method(D_METHOD("getLaunchCommandLine"), &SteamServer::getLaunchCommandLine);
	...
	ClassDB::bind_method(D_METHOD("getNumInstalledApps"), &SteamServer::getNumInstalledApps);
	...
	ClassDB::bind_method(D_METHOD("clearRichPresence"), &SteamServer::clearRichPresence);
	...
	ClassDB::bind_method(D_METHOD("getClanCount"), &SteamServer::getClanCount);
	...
	ClassDB::bind_method(D_METHOD("getCoplayFriendCount"), &SteamServer::getCoplayFriendCount);
	...
	ClassDB::bind_method(D_METHOD("getFriendCount"), &SteamServer::getFriendCount, DEFVAL(0x04));
	...
	ClassDB::bind_method(D_METHOD("getFriendsGroupCount"), &SteamServer::getFriendsGroupCount);
	...
	ClassDB::bind_method(D_METHOD("getPersonaName"), &SteamServer::getPersonaName);
	ClassDB::bind_method(D_METHOD("getPersonaState"), &SteamServer::getPersonaState);
	...
	ClassDB::bind_method(D_METHOD("getRecentPlayers"), &SteamServer::getRecentPlayers);
	ClassDB::bind_method(D_METHOD("getSmallFriendAvatar", "steam_id"), &SteamServer::getSmallFriendAvatar);
	ClassDB::bind_method(D_METHOD("getUserFriendsGroups"), &SteamServer::getUserFriendsGroups);
	ClassDB::bind_method(D_METHOD("getUserRestrictions"), &SteamServer::getUserRestrictions);
	ClassDB::bind_method(D_METHOD("getUserSteamFriends"), &SteamServer::getUserSteamFriends);
	ClassDB::bind_method(D_METHOD("getUserSteamGroups"), &SteamServer::getUserSteamGroups);
	...
	ClassDB::bind_method(D_METHOD("acceptGame"), &SteamServer::acceptGame);
	ClassDB::bind_method(D_METHOD("declineGame"), &SteamServer::declineGame);
	ClassDB::bind_method(D_METHOD("retrieveConnectionDetails", "host_id"), &SteamServer::retrieveConnectionDetails);
	ClassDB::bind_method(D_METHOD("endGameSearch"), &SteamServer::endGameSearch);
	...
	ClassDB::bind_method(D_METHOD("cancelRequestPlayersForGame"), &SteamServer::cancelRequestPlayersForGame);
	...
	ClassDB::bind_method(D_METHOD("getFavoriteGames"), &SteamServer::getFavoriteGames);
	...
	ClassDB::bind_method(D_METHOD("requestLobbyList"), &SteamServer::requestLobbyList);
...
//	ClassDB::bind_method(D_METHOD("setConfigValue", "setting", "scope_type", "connection_handle", "data_type", "value"), &Steam::setConfigValue);
	...
	ClassDB::bind_method(D_METHOD("createBeacon", "open_slots", "location_id", "type", "connect_string", "beacon_metadata"), &SteamServer::createBeacon);
	...
	ClassDB::bind_method(D_METHOD("getNumActiveBeacons"), &SteamServer::getNumActiveBeacons);
	...
	ClassDB::bind_method(D_METHOD("beginFileWriteBatch"), &SteamServer::beginFileWriteBatch);
	ClassDB::bind_method(D_METHOD("endFileWriteBatch"), &SteamServer::endFileWriteBatch);
	...
	ClassDB::bind_method(D_METHOD("getCachedUGCCount"), &SteamServer::getCachedUGCCount);
	ClassDB::bind_method(D_METHOD("getCachedUGCHandle", "content"), &SteamServer::getCachedUGCHandle);
	ClassDB::bind_method(D_METHOD("getFileCount"), &SteamServer::getFileCount);
	...
	ClassDB::bind_method(D_METHOD("getLocalFileChangeCount"), &SteamServer::getLocalFileChangeCount);
	ClassDB::bind_method(D_METHOD("getQuota"), &SteamServer::getQuota);
	...
	ClassDB::bind_method(D_METHOD("isCloudEnabledForAccount"), &SteamServer::isCloudEnabledForAccount);
	ClassDB::bind_method(D_METHOD("isCloudEnabledForApp"), &SteamServer::isCloudEnabledForApp);
	...
	ClassDB::bind_method(D_METHOD("getAvailableVoice"), &SteamServer::getAvailableVoice);
	ClassDB::bind_method(D_METHOD("getDurationControl"), &SteamServer::getDurationControl);
	ClassDB::bind_method(D_METHOD("getEncryptedAppTicket"), &SteamServer::getEncryptedAppTicket);
	ClassDB::bind_method(D_METHOD("getGameBadgeLevel", "series", "foil"), &SteamServer::getGameBadgeLevel);
	ClassDB::bind_method(D_METHOD("getPlayerSteamLevel"), &SteamServer::getPlayerSteamLevel);
	ClassDB::bind_method(D_METHOD("getSteamID"), &SteamServer::getSteamID);
	ClassDB::bind_method(D_METHOD("getVoice"), &SteamServer::getVoice);
	ClassDB::bind_method(D_METHOD("getVoiceOptimalSampleRate"), &SteamServer::getVoiceOptimalSampleRate);
	...
	ClassDB::bind_method(D_METHOD("isBehindNAT"), &SteamServer::isBehindNAT);
	ClassDB::bind_method(D_METHOD("isPhoneIdentifying"), &SteamServer::isPhoneIdentifying);
	ClassDB::bind_method(D_METHOD("isPhoneRequiringVerification"), &SteamServer::isPhoneRequiringVerification);
	ClassDB::bind_method(D_METHOD("isPhoneVerified"), &SteamServer::isPhoneVerified);
	ClassDB::bind_method(D_METHOD("isTwoFactorEnabled"), &SteamServer::isTwoFactorEnabled);
	...
	ClassDB::bind_method(D_METHOD("startVoiceRecording"), &SteamServer::startVoiceRecording);
	ClassDB::bind_method(D_METHOD("setDurationControlOnlineState", "new_state"), &SteamServer::setDurationControlOnlineState);
	ClassDB::bind_method(D_METHOD("stopVoiceRecording"), &SteamServer::stopVoiceRecording);
	...
	ClassDB::bind_method(D_METHOD("getMostAchievedAchievementInfo"), &SteamServer::getMostAchievedAchievementInfo);
	ClassDB::bind_method(D_METHOD("getNextMostAchievedAchievementInfo", "iterator"), &SteamServer::getNextMostAchievedAchievementInfo);
	ClassDB::bind_method(D_METHOD("getNumAchievements"), &SteamServer::getNumAchievements);
	ClassDB::bind_method(D_METHOD("getNumberOfCurrentPlayers"), &SteamServer::getNumberOfCurrentPlayers);
	...
	ClassDB::bind_method(D_METHOD("requestCurrentStats"), &SteamServer::requestCurrentStats);
	ClassDB::bind_method(D_METHOD("requestGlobalAchievementPercentages"), &SteamServer::requestGlobalAchievementPercentages);
	...
	ClassDB::bind_method(D_METHOD("storeStats"), &SteamServer::storeStats);
	...
	ClassDB::bind_method(D_METHOD("getLeaderboardEntries"), &SteamServer::getLeaderboardEntries);
